...
/** Summit's chrome: the info bar, the dark one-row header, the page, classic's footer. */
export function Chrome({
  ...
  return (
    <>
      ...
      <SiteFooter settings={settings} columns={footerMenu ?? undefined} bottomBar={bottomBar ?? undefined} />
    </>
  );
}
