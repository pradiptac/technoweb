  ...
  return (
    <form action={formAction} noValidate>
      ...
      <div className="grid gap-x-4 sm:grid-cols-2">
        <Field label="Category" htmlFor="ticket_category_id" error={err("ticket_category_id")}>
      ...
      <Field label="What is happening?" htmlFor="description" error={err("description")}
        ...
        <Textarea id="description" name="description" rows={7} required
          placeholder="Since this morning, laptops in the warehouse lose Wi-Fi every few minutes. The office side is fine. Started after the power cut on Tuesday."
          aria-invalid={Boolean(err("description"))} />
      </Field>

      <Field label="Attachments" htmlFor="attachments" error={err("attachments")}
        hint="Screenshots, photos, logs or a PDF. Up to 5 files, 10 MB each.">
