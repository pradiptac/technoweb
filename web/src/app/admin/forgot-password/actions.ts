...
import { requestStaffPasswordReset } from "@/lib/admin-auth";
import type { ForgotState } from "@/components/forms/forgot-password-form";

export async function requestStaffResetAction(_prev: ForgotState, formData: FormData): Promise<ForgotState> {
