...
/**
 * A swatch that is also the picker, beside a hex box. Shared by the theme
 * picker and the announcement panel — moved here from `theme-picker.tsx`
 * unchanged when the second caller arrived. Both write the same
